@extends('errors.layouts.error', ['title' => $pageTitle])
...
@section('content')
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2">{{ __('custom_admin.error_page_not_found') }} :(</h2>
            <p class="mb-4 mx-2">{{ __('custom_admin.message_page_not_found') }}</p>
            <a href="{{ url()->previous() }}" class="btn btn-primary">{{ __('custom_admin.btn_back_to_home') }}</a>
            <div class="mt-3">
